...
String myScript = "https://script.google.com/macros/s/AKfycbxdKAS4rsWoVc3TwEKMuEhyVr8QBmC_Cs0_-XOaAk0lNabZ2zT1Hpi38a95BtX4irzw7A/exec";    //Create your Google Apps Script and replace the "myScript" path.
String myRecipient = "mjunior@students.amikom.ac.id"; //Enter your Email address
...
void setup() {
  ...
  pinMode(pirPin, INPUT);    // sets the digital pin 2 as Input for push button
